...
//        }
    ...
    //TODO check if document could be obtained as a JSON/XML object
    // and offer to store as such... which would allow to use the DOMTagger
    // for extracting fields the way it is wanted.
