 ...
 */
public class ORIGINAL_CmisFileObject extends AbstractFileObject<CmisFileSystem> {

    private static final Logger LOG =
            LogManager.getLogger(ORIGINAL_CmisFileObject.class);

    private CmisObject cmisObject;

    protected ORIGINAL_CmisFileObject(AbstractFileName name, CmisFileSystem fileSystem) {
